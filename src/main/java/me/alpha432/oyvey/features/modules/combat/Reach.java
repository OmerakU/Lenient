...
public class HitboxExtender extends Module {
    ...
    public HitboxExtender() {
        super("HitboxExtend", "Тоглогчдын Hitbox болон Reach-ийг өргөтгөнө.", Category.COMBAT, true, false, false);
    }
    ...
    // This method would be used somewhere to get the current reach distance
